# Comparing `tmp/slowtestreporter-0.0.6.tar.gz` & `tmp/slowtestreporter-0.0.7.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "slowtestreporter-0.0.6.tar", last modified: Mon Apr  3 00:16:53 2023, max compression
+gzip compressed data, was "slowtestreporter-0.0.7.tar", last modified: Mon Apr 10 04:17:29 2023, max compression
```

## Comparing `slowtestreporter-0.0.6.tar` & `slowtestreporter-0.0.7.tar`

### file list

```diff
@@ -1,26 +1,27 @@
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-03 00:16:53.707126 slowtestreporter-0.0.6/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-03 00:16:53.699126 slowtestreporter-0.0.6/.github/
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-03 00:16:53.703126 slowtestreporter-0.0.6/.github/workflows/
--rw-r--r--   0 runner    (1001) docker     (123)      431 2023-04-03 00:16:34.000000 slowtestreporter-0.0.6/.github/workflows/publish.yml
--rw-r--r--   0 runner    (1001) docker     (123)      990 2023-04-03 00:16:34.000000 slowtestreporter-0.0.6/.github/workflows/python-app.yml
--rw-r--r--   0 runner    (1001) docker     (123)     1805 2023-04-03 00:16:34.000000 slowtestreporter-0.0.6/.gitignore
--rw-r--r--   0 runner    (1001) docker     (123)     1065 2023-04-03 00:16:34.000000 slowtestreporter-0.0.6/LICENSE
--rw-r--r--   0 runner    (1001) docker     (123)     1323 2023-04-03 00:16:53.703126 slowtestreporter-0.0.6/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      919 2023-04-03 00:16:34.000000 slowtestreporter-0.0.6/README.md
--rw-r--r--   0 runner    (1001) docker     (123)      703 2023-04-03 00:16:34.000000 slowtestreporter-0.0.6/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (123)      160 2023-04-03 00:16:34.000000 slowtestreporter-0.0.6/requirements.txt
--rw-r--r--   0 runner    (1001) docker     (123)       38 2023-04-03 00:16:53.707126 slowtestreporter-0.0.6/setup.cfg
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-03 00:16:53.703126 slowtestreporter-0.0.6/slowtestreporter/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-03 00:16:34.000000 slowtestreporter-0.0.6/slowtestreporter/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     1979 2023-04-03 00:16:34.000000 slowtestreporter-0.0.6/slowtestreporter/cli.py
--rw-r--r--   0 runner    (1001) docker     (123)     2613 2023-04-03 00:16:34.000000 slowtestreporter-0.0.6/slowtestreporter/slowtestreporter.py
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-03 00:16:53.703126 slowtestreporter-0.0.6/slowtestreporter.egg-info/
--rw-r--r--   0 runner    (1001) docker     (123)     1323 2023-04-03 00:16:53.000000 slowtestreporter-0.0.6/slowtestreporter.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (123)      506 2023-04-03 00:16:53.000000 slowtestreporter-0.0.6/slowtestreporter.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (123)        1 2023-04-03 00:16:53.000000 slowtestreporter-0.0.6/slowtestreporter.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (123)       63 2023-04-03 00:16:53.000000 slowtestreporter-0.0.6/slowtestreporter.egg-info/entry_points.txt
--rw-r--r--   0 runner    (1001) docker     (123)       62 2023-04-03 00:16:53.000000 slowtestreporter-0.0.6/slowtestreporter.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (123)       17 2023-04-03 00:16:53.000000 slowtestreporter-0.0.6/slowtestreporter.egg-info/top_level.txt
-drwxr-xr-x   0 runner    (1001) docker     (123)        0 2023-04-03 00:16:53.703126 slowtestreporter-0.0.6/tests/
--rw-r--r--   0 runner    (1001) docker     (123)        0 2023-04-03 00:16:34.000000 slowtestreporter-0.0.6/tests/__init__.py
--rw-r--r--   0 runner    (1001) docker     (123)     3661 2023-04-03 00:16:34.000000 slowtestreporter-0.0.6/tests/test_slow_test_reporter.py
...
### Comparing `slowtestreporter-0.0.6/.github/workflows/python-app.yml` & `slowtestreporter-0.0.7/.github/workflows/python-app.yml`

 * *Files identical despite different names*

### Comparing `slowtestreporter-0.0.6/.gitignore` & `slowtestreporter-0.0.7/.gitignore`

 * *Files identical despite different names*

### Comparing `slowtestreporter-0.0.6/LICENSE` & `slowtestreporter-0.0.7/LICENSE`

 * *Files identical despite different names*

### Comparing `slowtestreporter-0.0.6/PKG-INFO` & `slowtestreporter-0.0.7/PKG-INFO`
...
### Comparing `slowtestreporter-0.0.6/README.md` & `slowtestreporter-0.0.7/README.md`

 * *Files identical despite different names*

### Comparing `slowtestreporter-0.0.6/pyproject.toml` & `slowtestreporter-0.0.7/pyproject.toml`

 * *Files identical despite different names*

### Comparing `slowtestreporter-0.0.6/slowtestreporter/slowtestreporter.py` & `slowtestreporter-0.0.7/slowtestreporter/slowtestreporter.py`
...
### Comparing `slowtestreporter-0.0.6/slowtestreporter.egg-info/PKG-INFO` & `slowtestreporter-0.0.7/slowtestreporter.egg-info/PKG-INFO`
