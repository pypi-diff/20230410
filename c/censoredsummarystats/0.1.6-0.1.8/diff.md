# Comparing `tmp/censoredsummarystats-0.1.6.tar.gz` & `tmp/censoredsummarystats-0.1.8.tar.gz`
...
## Comparing `censoredsummarystats-0.1.6.tar` & `censoredsummarystats-0.1.8.tar`
...
### Comparing `censoredsummarystats-0.1.6/censoredsummarystats/__init__.py` & `censoredsummarystats-0.1.8/censoredsummarystats/__init__.py`
...
+from .censoredsummarystats import string_precision, numeric_precision, interval_notation, result_to_components, components_to_interval, interval_to_components, components_to_result, maximum_interval, maximum, minimum_interval, minimum, average_interval, average, percentile_interval, percentile, median
...
+__all__ = [string_precision, numeric_precision, interval_notation, result_to_components, components_to_interval, interval_to_components, components_to_result, maximum_interval, maximum, minimum_interval, minimum, average_interval, average, percentile_interval, percentile, median]
```

### Comparing `censoredsummarystats-0.1.6/censoredsummarystats/censoredsummarystats.py` & `censoredsummarystats-0.1.8/censoredsummarystats/censoredsummarystats.py`
...
### Comparing `censoredsummarystats-0.1.6/LICENSE` & `censoredsummarystats-0.1.8/LICENSE`

 * *Files identical despite different names*

### Comparing `censoredsummarystats-0.1.6/pyproject.toml` & `censoredsummarystats-0.1.8/pyproject.toml`
...
### Comparing `censoredsummarystats-0.1.6/PKG-INFO` & `censoredsummarystats-0.1.8/PKG-INFO`
